  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10">
        ...
        {/* Left column: Header, Title, Text, and Cards (stacked) */}
        <div className="lg:col-span-7 flex flex-col justify-start">
          <span className="font-mono text-[15px] uppercase tracking-[0.25em] text-acaf-coral mb-4 block">
            Quem Somos
          </span>
          <h2 className="text-3xl md:text-4xl font-sans font-semibold text-acaf-forest leading-tight tracking-tight max-w-2xl">
          ...
          <p className={`text-[16px] text-acaf-sage mb-10 leading-relaxed font-light transition-all duration-700 ease-out ${
          ...
          {/* Core values list (stacked one below the other) */}
        ...
        {/* Right column: Empty space for architectural balance */}
